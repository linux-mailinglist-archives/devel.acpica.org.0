...
Received: from ml01.01.org (ml01.01.org [198.145.21.10])
	by mail.lfdr.de (Postfix) with ESMTPS id C964E443583
	for <lists+devel-acpica@lfdr.de>; Tue,  2 Nov 2021 19:26:16 +0100 (CET)
Received: from ml01.vlan13.01.org (localhost [IPv6:::1])
	by ml01.01.org (Postfix) with ESMTP id 15A8D100EA2AE;
...
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
	by ml01.01.org (Postfix) with ESMTP id 44B97100EA2AB
	for <devel@acpica.org>; Tue,  2 Nov 2021 11:26:12 -0700 (PDT)
...
MIME-Version: 1.0
Message-ID-Hash: C6CZPEJ476V5SSBRTUACPQDOJJCIODJ3
X-Message-ID-Hash: C6CZPEJ476V5SSBRTUACPQDOJJCIODJ3
...
Precedence: list
Subject: [Devel] [PATCH 1/3] ACPICA: Fix wrong interpretation of PCC address
List-Id: ACPICA Developer Mailing List <devel.acpica.org>
Archived-At: <https://lists.acpica.org/hyperkitty/list/devel@acpica.org/message/C6CZPEJ476V5SSBRTUACPQDOJJCIODJ3/>
