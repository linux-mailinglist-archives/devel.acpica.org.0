...
Received: from ml01.01.org (ml01.01.org [IPv6:2001:19d0:306:5::1])
	by mail.lfdr.de (Postfix) with ESMTPS id BB57451B19F
	for <lists+devel-acpica@lfdr.de>; Thu,  5 May 2022 00:08:45 +0200 (CEST)
Received: from ml01.vlan13.01.org (localhost [IPv6:::1])
	by ml01.01.org (Postfix) with ESMTP id 96DA7100EA13E;
	Wed,  4 May 2022 15:08:43 -0700 (PDT)
Received-SPF: Pass (mailfrom) identity=mailfrom; client-ip=2a01:111:f400:7eab::608; helo=nam11-co1-obe.outbound.protection.outlook.com; envelope-from=bwicaksono@nvidia.com; receiver=<UNKNOWN> 
Received: from NAM11-CO1-obe.outbound.protection.outlook.com (mail-co1nam11on20608.outbound.protection.outlook.com [IPv6:2a01:111:f400:7eab::608])
	...
	by ml01.01.org (Postfix) with ESMTPS id 1AF9A100EA12F
	for <devel@acpica.org>; Wed,  4 May 2022 15:08:41 -0700 (PDT)
...
Message-ID-Hash: ID3TMMHPR4PCFJ22KKVUQO37XOVPBOB6
X-Message-ID-Hash: ID3TMMHPR4PCFJ22KKVUQO37XOVPBOB6
X-MailFrom: bwicaksono@nvidia.com
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; nonmember-moderation; administrivia; implicit-dest; max-recipients; max-size; news-moderation; no-subject; suspicious-header
CC: "catalin.marinas@arm.com" <catalin.marinas@arm.com>, "will@kernel.org" <will@kernel.org>, "lorenzo.pieralisi@arm.com" <lorenzo.pieralisi@arm.com>, "linux-tegra@vger.kernel.org" <linux-tegra@vger.kernel.org>, Thierry Reding <treding@nvidia.com>, Jonathan Hunter <jonathanh@nvidia.com>, "linux-acpi@vger.kernel.org" <linux-acpi@vger.kernel.org>, "devel@acpica.org" <devel@acpica.org>, "linux-kernel@vger.kernel.org" <linux-kernel@vger.kernel.org>, "linux-arm-kernel@lists.infradead.org" <linux-arm-kernel@lists.infradead.org>
X-Mailman-Version: 3.1.1
Precedence: list
Subject: [Devel] Re: [PATCH 2/2] ACPI: ARM Performance Monitoring Unit Table (APMT) initial support
List-Id: ACPICA Developer Mailing List <devel.acpica.org>
Archived-At: <https://lists.acpica.org/hyperkitty/list/devel@acpica.org/message/7FUVBO6IAODOZLG3ISA7B2ASRHB6PIWC/>
...
IGRldmljZSBuYW1lLg0KDQpSZWdhcmRzLA0KQmVzYXINCg0KX19fX19fX19fX19fX19fX19fX19f
