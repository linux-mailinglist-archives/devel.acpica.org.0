...
Received: from ml01.01.org (ml01.01.org [IPv6:2001:19d0:306:5::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 3E93A415EE4
	for <lists+devel-acpica@lfdr.de>; Thu, 23 Sep 2021 14:55:08 +0200 (CEST)
Received: from ml01.vlan13.01.org (localhost [IPv6:::1])
	by ml01.01.org (Postfix) with ESMTP id 88538100EB349;
...
Received: from mail-ot1-f44.google.com (mail-ot1-f44.google.com [209.85.210.44])
	...
	by ml01.01.org (Postfix) with ESMTPS id 1AD07100EB337
	for <devel@acpica.org>; Thu, 23 Sep 2021 05:55:03 -0700 (PDT)
Received: by mail-ot1-f44.google.com with SMTP id x33-20020a9d37a4000000b0054733a85462so8326833otb.10
        for <devel@acpica.org>; Thu, 23 Sep 2021 05:55:03 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        b=
X-Gm-Message-State: AOAM531zPFMccdA642vBSZFpsGEH/EVk+v3Ghrr5i2snb5TG3aE9/YOd
	iO3ebGWmsOISnDYpFUVfKXhh8TPJuJwRynOwGso=
...
Message-ID-Hash: BDZJZSVIHHKPBWH7VZYLVRKLW2EXA7LC
X-Message-ID-Hash: BDZJZSVIHHKPBWH7VZYLVRKLW2EXA7LC
X-MailFrom: rjwysocki@gmail.com
X-Mailman-Rule-Hits: nonmember-moderation
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation
CC: "Rafael J. Wysocki" <rafael@kernel.org>, Lorenzo Pieralisi <lorenzo.pieralisi@arm.com>, Jia He <justin.he@arm.com>, Harb Abdulhamid <harb@amperecomputing.com>, Will Deacon <will@kernel.org>, Erik Kaneda <erik.kaneda@intel.com>, Linux ARM <linux-arm-kernel@lists.infradead.org>, Linux Kernel Mailing List <linux-kernel@vger.kernel.org>, ACPI Devel Maling List <linux-acpi@vger.kernel.org>, "open list:ACPI COMPONENT ARCHITECTURE (ACPICA)" <devel@acpica.org>, Ard Biesheuvel <ardb@kernel.org>, Catalin Marinas <catalin.marinas@arm.com>, Rafael Wysocki <rafael.j.wysocki@intel.com>
X-Mailman-Version: 3.1.1
Precedence: list
Subject: [Devel] Re: [PATCH v2] Revert "ACPI: Add memory semantics to acpi_os_map_memory()"
List-Id: ACPICA Developer Mailing List <devel.acpica.org>
Archived-At: <https://lists.acpica.org/hyperkitty/list/devel@acpica.org/message/BDZJZSVIHHKPBWH7VZYLVRKLW2EXA7LC/>
