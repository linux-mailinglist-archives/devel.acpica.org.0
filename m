...
Received: from ml01.01.org (ml01.01.org [IPv6:2001:19d0:306:5::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 7A3A95E8FC0
	for <lists+devel-acpica@lfdr.de>; Sat, 24 Sep 2022 22:58:10 +0200 (CEST)
Received: from ml01.vlan13.01.org (localhost [IPv6:::1])
	by ml01.01.org (Postfix) with ESMTP id 71A3C100EB341;
	Sat, 24 Sep 2022 13:58:07 -0700 (PDT)
...
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
	...
	by ml01.01.org (Postfix) with ESMTPS id 4D044100EB331
	for <devel@acpica.org>; Sat, 24 Sep 2022 13:58:05 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1664053085; x=1695589085;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=2j3mZdCV1QjOPV9e4J5cy1dnPmVzQdapXc14/qKv+uY=;
  b=fbA8dxgLvdH7RoP4hIQx05Cx9qH99X+FbHqyF8r6544m27zqfD8jJLzY
   Fw66PAJ4egqHgmspnou3CLxPaZ2Uoi3sbheu9OVAD47xj+2J6hiNbZODp
   FxIUtad8ZCicUsbr9B73qlF+NIjw5J5NWUnzTp4sZxdrpWFBSKRdpg49E
   dT4NDaUgM4uz4w87BYDYrmCmf1nG+yqvwA5vupgAfqFsnXDzseVA4XsNS
   GfhTtU5vR7+C4OrL9zesmnderDxDnpaHx7H35DzbQMPgM83t0jMYl6u/O
   iBgbtZhtzeFd/iYlj4mGEAhU9fuyQSZarydIWMK6uZ+5S612Z7i631krN
   g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10480"; a="299531311"
X-IronPort-AV: E=Sophos;i="5.93,342,1654585200";
   d="scan'208";a="299531311"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 24 Sep 2022 13:58:04 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,342,1654585200";
   d="scan'208";a="949411507"
Received: from lkp-server01.sh.intel.com (HELO c0a60f19fe7e) ([10.239.97.150])
  by fmsmga005.fm.intel.com with ESMTP; 24 Sep 2022 13:58:01 -0700
Received: from kbuild by c0a60f19fe7e with local (Exim 4.96)
	(envelope-from <lkp@intel.com>)
	id 1ocCDp-000702-0c;
	Sat, 24 Sep 2022 20:58:01 +0000
Date: Sun, 25 Sep 2022 04:57:09 +0800
From: kernel test robot <lkp@intel.com>
To: Kai-Heng Feng <kai.heng.feng@canonical.com>
Message-ID: <202209250438.1vajrE1K-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="BkE5y6ue0vgU+ny2"
Content-Disposition: inline
Message-ID-Hash: 4W7MI7DPXNCUP4ILSI7C4AJN47FMG56N
X-Message-ID-Hash: 4W7MI7DPXNCUP4ILSI7C4AJN47FMG56N
...
Precedence: list
Subject: [Devel] [rafael-pm:bleeding-edge 151/187] drivers/acpi/sleep.c:1096:42: error: 'SYS_OFF_MODE_RESTART_PREPARE' undeclared; did you mean 'SYS_OFF_MODE_RESTART'?
List-Id: ACPICA Developer Mailing List <devel.acpica.org>
Archived-At: <https://lists.acpica.org/hyperkitty/list/devel@acpica.org/message/4W7MI7DPXNCUP4ILSI7C4AJN47FMG56N/>
...
head:   ecfa396ef37aea5cf4b20db57585af16b110ac6b
commit: 9e8e4e81b6f5943a8ae52cfce7191a119095d097 [151/187] ACPI: PM: reboot: Reinstate S5 for reboot
config: x86_64-randconfig-a013
compiler: gcc-11 (Debian 11.3.0-5) 11.3.0
reproduce (this is a W=1 build):
        # https://git.kernel.org/pub/scm/linux/kernel/git/rafael/linux-pm.git/commit/?id=9e8e4e81b6f5943a8ae52cfce7191a119095d097
        git remote add rafael-pm https://git.kernel.org/pub/scm/linux/kernel/git/rafael/linux-pm.git
        git fetch --no-tags rafael-pm bleeding-edge
        git checkout 9e8e4e81b6f5943a8ae52cfce7191a119095d097
...
>> drivers/acpi/sleep.c:1096:42: error: 'SYS_OFF_MODE_RESTART_PREPARE' undeclared (first use in this function); did you mean 'SYS_OFF_MODE_RESTART'?
   ...
   drivers/acpi/sleep.c:1096:42: note: each undeclared identifier is reported only once for each function it appears in


vim +1096 drivers/acpi/sleep.c
