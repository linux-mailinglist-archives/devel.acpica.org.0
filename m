...
Received: from ml01.01.org (ml01.01.org [198.145.21.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 79F45406D2E
	for <lists+devel-acpica@lfdr.de>; Fri, 10 Sep 2021 15:54:58 +0200 (CEST)
Received: from ml01.vlan13.01.org (localhost [IPv6:::1])
	by ml01.01.org (Postfix) with ESMTP id 59465100EBBDD;
	Fri, 10 Sep 2021 06:54:56 -0700 (PDT)
...
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
	by ml01.01.org (Postfix) with ESMTP id 3AA03100EBBBB
	for <devel@acpica.org>; Fri, 10 Sep 2021 06:54:53 -0700 (PDT)
...
Message-ID-Hash: C3TPVRLVZCOOQHZD4FDFJMKF3OTZVFZE
X-Message-ID-Hash: C3TPVRLVZCOOQHZD4FDFJMKF3OTZVFZE
X-MailFrom: lorenzo.pieralisi@arm.com
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; nonmember-moderation; administrivia; implicit-dest; max-recipients; max-size; news-moderation; no-subject; suspicious-header
CC: Will Deacon <will@kernel.org>, Erik Kaneda <erik.kaneda@intel.com>, linux-arm-kernel@lists.infradead.org, linux-kernel@vger.kernel.org, linux-acpi@vger.kernel.org, devel@acpica.org, Ard Biesheuvel <ardb@kernel.org>, Catalin Marinas <catalin.marinas@arm.com>, "Rafael J . Wysocki" <rafael.j.wysocki@intel.com>, harb@amperecomputing.com
X-Mailman-Version: 3.1.1
Precedence: list
Subject: [Devel] Re: [PATCH] Revert "ACPI: Add memory semantics to acpi_os_map_memory()"
List-Id: ACPICA Developer Mailing List <devel.acpica.org>
Archived-At: <https://lists.acpica.org/hyperkitty/list/devel@acpica.org/message/C3TPVRLVZCOOQHZD4FDFJMKF3OTZVFZE/>
